...
/**
 * Interactive Mode Controller is used by operators to manage and modify the
 * User List. The Controller is able to add, delete, or modify members and
 * providers from the User List
 *
...
public class InteractiveModeController {
	...
	/**
	 * Default Constructor Creates user list from saved user list data by declaring
	 * new userlist object with default path default path is saved in UserList
	 *
	 */
	...
	/**
	 * Modifies a providers info in the user list parameter datType relates to piece
	 * of data in Member object, converts to int 1- Name 2- address 3- city 4- state
	 * 5- zip code
	 */
	 ...
	 */
	public void addMember(String name, String address, String city, String state, int zip_code,
	...
	/**
	 * Modifies a members info in the user list parameter datType relates to piece
	 * of data in Member object 1- Name 2- address 3- city 4- state 5- zip code
	 * 6-member status
	 */
