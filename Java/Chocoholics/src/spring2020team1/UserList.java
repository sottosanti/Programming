...
/**
 * UserList contains a complete list of all Members and Providers Functionality
 * to add, edit, or remove Members and Providers
 *
...
public class UserList {
	...
	/**
	 * Default constructor, uses default path to read members and providers from
	 * text file fills into two ArrayLists, one for members and one for providers
	 *
	...
	public UserList() {
		...
		try {
			reader = new BufferedReader(new FileReader(MEMBERS_PATH));
		...
		try {
			reader = new BufferedReader(new FileReader(PROVIDERS_PATH));
			String line = reader.readLine();
			while (line != null) {
	...
	/**
	 * Using id number to search, edits a member's data depending on integer passed
	 * in
	 *
	...
	/**
	 * Using id number to search, edits a provider's data depending on integer
	 * passed in
	 *
	 * @param memNum  ID number of member to edit
	 *
	...
	/**
	 * searching with id number, returns true if member is found in list and false
	 * otherwise
	 *
	 * @param memNum id number of member to delete
	 */
	...
	/**
	 * searching with id number, returns true if provider is found in list and false
	 * otherwise
	 *
	 * @param proNum id number of provider to delete
	 */
