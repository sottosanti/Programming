...
/**
 * Service represents one specific service that can be performed by a ChocAn
 * service provider.
 *
 *
...
public class Service {
	...
	/**
	 * Parameterized constructor which creates a new service object that represents
	 * a service which can be performed by a ChocAn service provider.
	 *
	 * @param serviceCode        A 6-digit service code representing a unique
	 *                           identifier for a Service object.
	 * @param serviceName        The name of a Service, such as "30 minute
	 *                           counseling session", "1-week diet plan", etc.
	...
	/**
	 * Query and retrieve the 6-digit service code of the Service
	 *
	...
	/**
	 * Query and retrieve the service name of the Service
	 * 
	 ...
	 *
	 * @param serviceDescription A String representing the description of the
	 *                           Service
	 */
	...
	/**
	 * Query and retrieve the fee (dollar amount) of the Service.
	 *
	 * @return The amount in dollars corresponding to the Service
	 */
	 ...
	 *
	 * @param serviceFee A float representing the dollar amount corresponding to the
	 *                   Service
	 */
