...
public class ServiceRecord {
  ...
  public serviceRecord(String dts, String sd, int pn, int mn, int sc, String comment) {
	 ...
	 * @param none
	 *
	 * @return sd the date of the service
	 */
	 ...
	 * @param none
	 *
	 * @return sc the service code used
	 */
	 ...
	 * @param none
	 *
	 * @return returns a comment if they wish to enter a comment
	 */
