...
/**
 * ReportController is a control class which is responsible for the compilation
 * and distribution of Service Record Reports.
 *
 * <p>
 * ReportController can be invoked by an operator or manager at any time, but it
 * also includes functionality to automatically compile and send reports every
 * week.
 * </p>
 *
