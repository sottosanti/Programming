...
ices that can be performed by a ChocAn*service provider.*It only contains an array of Service objects*called"serviceList"and the total number*of objects in that array,called"numServices"**@author Stephen Gregory
 * @version     %I%, %G%
 * @since       1.0
 */
